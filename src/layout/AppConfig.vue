...
export default {
    ...
    data() {
        return {
            active: false,
            theme: 'blue',
            logoBlackHorizontal: import.meta.env.VITE_APP_PATH_TO_LOGO_BLACK_HORIZONTAL,
    ...
    methods: {
        ...
        changeStyleSheetUrl(id, value, prefix) {
            ...
            if (value.localeCompare('yellow') === 0 || value.localeCompare('lime') === 0) {
                topbarLogo.src = logoBlackHorizontal;
                menuLogo.src = logoBlackHorizontal;
            } else {
                topbarLogo.src = this.logoWhiteHorizontal;
                menuLogo.src = this.logoWhiteHorizontal;
            }
        },
